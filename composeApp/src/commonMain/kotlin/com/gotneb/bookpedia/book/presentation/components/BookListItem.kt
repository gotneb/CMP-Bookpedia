...
import com.gotneb.bookpedia.core.presentation.LightBlue
import com.gotneb.bookpedia.core.presentation.SandYellow
import cpm_bookpedia.composeapp.generated.resources.Res
import cpm_bookpedia.composeapp.generated.resources.compose_multiplatform
        ...
        Row(
            ...
            Box(
                ...
                when (val result = imageLoadResult) {
                    null -> CircularProgressIndicator(modifier = Modifier.size(60.dp))
                    else -> Image(
